...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.graphWidget = PlotWidget(self.gridLayoutWidget, background='w')
        ...
        self.gridLayout_3.addWidget(self.line_intervalB, 5, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.but_Graph, 9, 0, 1, 1)

        self.line_step = QLineEdit(self.gridLayoutWidget)
        self.line_step.setObjectName(u"line_step")

        self.gridLayout_3.addWidget(self.line_step, 7, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.line_intervalA, 4, 0, 1, 1)
